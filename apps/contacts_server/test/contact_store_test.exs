defmodule ContactServer.ContactStoreTest do
  ...
  test "adding a contact puts the contact in the store", %{store: store} do
    contact = %{last_name: "a", first_name: "b", email: "c", favorite_color: "d", dob: ~D[2020-01-01]}
  ...
  test "adding the two contacts differing by date adds both contacts", %{store: store} do
    contact1 = %{last_name: "a", first_name: "b", email: "c", favorite_color: "d", dob: ~D[2020-01-01]}
    contact2 = %{last_name: "aa", first_name: "b", email: "c", favorite_color: "d", dob: ~D[1920-01-01]}
